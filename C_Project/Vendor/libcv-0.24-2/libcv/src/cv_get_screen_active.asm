...
;--------------------------------------------------------
	.area _CODE
;src/cv_get_screen_active.c:7: bool cv_get_screen_active(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function cv_get_screen_active
; ---------------------------------
;	Register assignment might be sub-optimal.
; Stack space usage: 0 bytes.
_cv_get_screen_active::
;src/cv_get_screen_active.c:9: return(cv_vdpreg[1] & 0x40);
;	genPointerGet
