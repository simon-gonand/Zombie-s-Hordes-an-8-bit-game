...
;--------------------------------------------------------
	.area _CODE
;src/cv_set_hscroll.c:5: void cv_set_hscroll(uint8_t offset)
;	genLabel
;	genFunction
;	---------------------------------
; Function cv_set_hscroll
; ---------------------------------
;	Register assignment is optimal.
; Stack space usage: 0 bytes.
_cv_set_hscroll::
;src/cv_set_hscroll.c:7: cv_vdpout(0x8, offset);
;	genIpush
