...
;--------------------------------------------------------
	.area _CODE
;src/cv_set_image_table.c:5: void cv_set_image_table(cv_vmemp loc)
;	genLabel
;	genFunction
;	---------------------------------
; Function cv_set_image_table
; ---------------------------------
;	Register assignment is optimal.
; Stack space usage: 0 bytes.
_cv_set_image_table::
;src/cv_set_image_table.c:7: cv_vdpout(0x2, loc >> 10);
;	genRightShift
