...
;--------------------------------------------------------
	.module cv_set_sprite_attribute_table
	.optsdcc -mz80
...
;--------------------------------------------------------
	.area _CODE
;src/cv_set_sprite_attribute_table.c:5: void cv_set_sprite_attribute_table(cv_vmemp loc)
;	genLabel
;	genFunction
;	---------------------------------
; Function cv_set_sprite_attribute_table
; ---------------------------------
;	Register assignment is optimal.
; Stack space usage: 0 bytes.
_cv_set_sprite_attribute_table::
;src/cv_set_sprite_attribute_table.c:7: cv_vdpout(0x5, loc >> 7);
;	genRightShift
...
;src/cv_set_sprite_attribute_table.c:8: }
;	genEndFunction
	ret
	.area _CODE
	.area _INITIALIZER
