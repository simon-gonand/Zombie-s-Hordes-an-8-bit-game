...
;--------------------------------------------------------
	.module cv_get_external_video
	.optsdcc -mz80
	
;--------------------------------------------------------
; Public variables in this module
;--------------------------------------------------------
	.globl _cv_get_external_video
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area _CODE
;src/cv_get_external_video.c:7: bool cv_get_external_video(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function cv_get_external_video
; ---------------------------------
;	Register assignment might be sub-optimal.
; Stack space usage: 0 bytes.
_cv_get_external_video::
;src/cv_get_external_video.c:9: return(cv_vdpreg[0] & 0x02);
;	genPointerGet
	ld	a, (#_cv_vdpreg + 0)
;	genCast
;	genMove_o
...
;src/cv_get_external_video.c:10: }
;	genEndFunction
	ret
	.area _CODE
	.area _INITIALIZER
